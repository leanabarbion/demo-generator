const categories = [
  {
    name: "Extra",
    technologies: [
      { id: 80, name: "Data_SFDC" },
      { id: 81, name: "Data_Market_API" },
      { id: 82, name: "Data_SAP_inventory" },
      { id: 83, name: "Data_Weather_API" },
      { id: 84, name: "JobDatabaseSQLScript" },
      { id: 85, name: "JobFileTransfer" },
